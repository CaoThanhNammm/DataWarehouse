...
SELECT 
    ...
    COALESCE(tp.price, 'N/A'),  
    COALESCE(tp.priceSale, 'N/A'),  
    COALESCE(tp.brand, 'N/A'), 
    COALESCE(tp.color, 'N/A'),
...
-- 						 AND	pd2.description_part1 = tp.description_part1 
--             AND  pd2.description_part2 = tp.description_part2 
--             AND  pd2.description_part3 = tp.description_part3 
--             AND pd2.isDelete = FALSE
--             AND pd2.expired_date = '9999-12-31'
--             AND (
--                 pd2.price <> tp.price OR
--                 pd2.priceSale <> tp.priceSale OR
